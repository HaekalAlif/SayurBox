        ...
        <div className="flex items-center justify-between px-4">
          ...
          <div className="w-[25%] flex items-center space-x-3">
            <div className="flex items-center">
              <img
                src="/src/assets/header/sayurbox-logo.png"
                alt="Sayurbox Logo"
          ...
          <div className="w-[90%]">
            <div className="relative">
              ...
              <button className="absolute right-3 top-1/2 transform -translate-y-1/2 p-2 rounded-full">
                <img src="/src/assets/header/search.png" className="w-8" />
              </button>
            </div>
          </div>
          ...
          <div className="w-[50%] flex items-center space-x-10 justify-end">
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center cursor-pointer">
                <img src="/src/assets/header/cart.png" className="w-8" />
              </div>
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center cursor-pointer">
                <img src="/src/assets/header/bill.png" className="w-8" />
              </div>
              <div
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center cursor-pointer">
                <img src="/src/assets/header/cart-2.png" className="w-8" />
              </div>
            ...
            >
              <img src="/src/assets/header/profile.png" alt="" />
            </div>
          </div>
        </div>
      </div>
